...
module internal Parser
    ...
    let mkBoard : boardProg -> board = fun bp -> {center = (0,0); defaultSquare = Map.empty; squares = (fun _ -> Success (Some Map.empty)); isOnBoard = (ScrabbleLib.simpleBoardLangParser.parseSimpleBoardProg bp)}
